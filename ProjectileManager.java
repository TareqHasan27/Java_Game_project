...
public class ProjectileManager {
    ...
    // Updated method to accept a color parameter
    public void fireProjectile(int startX, int startY, int dx, int dy, Color color) {
        int radius = 5; // or whatever radius you want
        projectiles.add(new Projectile(startX, startY, dx, dy, radius, color));
    }
